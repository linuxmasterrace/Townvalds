function CreateDatabase()
	...
	local sqlCreate = {
		...
		"CREATE TABLE IF NOT EXISTS residents (player_uuid STRING NOT NULL PRIMARY KEY, player_name STRING NOT NULL UNIQUE, town_id INTEGER, town_rank STRING, last_online INTEGER, FOREIGN KEY (town_id) REFERENCES towns(town_id) ON UPDATE CASCADE ON DELETE SET NULL)",
