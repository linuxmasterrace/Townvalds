function CreateDatabase()
	...
	sqlCreate[3] = "CREATE TABLE IF NOT EXISTS residents (player_uuid STRING NOT NULL PRIMARY KEY UNIQUE, player_name STRING NOT NULL UNIQUE, town_id INTEGER, town_rank STRING, last_online INTEGER, first_joined INTEGER)";
